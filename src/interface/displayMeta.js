...
export const initDisplayMetaData = function initDisplayMetaDataOnThePage(
  resolvedAddress,
  tempDescription,
  cityTemp,
  icon,
  ...
  addressTitle.textContent = resolvedAddress
    .split(",")[0]
    .toString()
    .toLowerCase();
  ...
  currentTemp.textContent = !tempMode.isCelsius
    ? `${cityTemp} F°`
    : `${cityTemp} C°`;
...
export const displayExistingMetaData =
  function displayExistingMetaDataOnThePage(
    resolvedAddress,
    tempDescription,
    cityTemp,
    icon,
