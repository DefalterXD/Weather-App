import {
  displayExistingConditionData,
  initDisplayConditionData,
} from "./displayCondition.js";
import {
  displayExistingHoursData,
  initDisplayHoursData,
} from "./displayHours.js";
...
export const displayData = function displayDataAboutCityInPage(city) {
  ...
  if (metaSection) {
    ...
    metaSection = initDisplayMetaData(
      city.resolvedAddress,
      city.conditions,
      city.temp,
      city.icon,
  ...
  if (conditionSection) {
    displayExistingConditionData(
      ...
      city.windspeed,
      city.uvindex,
      city.firstWeekDays[0].dew,
    );
  } else {
    conditionSection = initDisplayConditionData(
      city.feelslike,
      city.windspeed,
      city.uvindex,
      city.firstWeekDays[0].dew,
